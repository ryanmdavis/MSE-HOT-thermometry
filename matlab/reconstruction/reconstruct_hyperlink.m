...
switch scan_data.Method
    ...
    case {'RARE ','rMD_HOT_RARE '}
        ...
        fun_link_text = fun_link_text_cell{1};
    case {'MSME '}
        fun_link_text_cell = strcat({'<a href="matlab: [MSME_'},exp_name,'_Sc',exp_num,'] = reconstructBrukerSLI(''',directory,'\',exp_num,{''');">Scan '},exp_num,{':</a>'},{'    '});
        fun_link_text = fun_link_text_cell{1};
...
%                 fun_link_text = fun_link_text_cell{1};
            ...
            case 'HOT_2D_RARE_ZQSQ2 '
                switch p_meth.RARE_mode
                    ...
                    case {'N_images ','none '}
                        start_to_exc_2 = {'<a href="matlab: '};
                        expressions_to_exc_2 = {strcat('[',exp_name,'_Sc',exp_num,'_HOT] = reconstructMSEHOT(''',directory,'\',exp_num,''');')};
...
%         fun_link_text_cell = strcat({'<a href="matlab: '},exp_name,'_Sc',exp_num,'_T2 = reconstructPRESST2(''',directory,'\',exp_num,{''');">Scan '},exp_num,{':</a>'},{'    '});
    ...
    case 'rMD_CRAZED2 '
        ...
        if  p_meth.t1_inc == 1
            ...
            fun_link_text_cell = strcat({'<a href="matlab: ['},exp_name,'_Sc',exp_num,'_CRAZED] = reconstructBrukerCRAZEDT2star(''',directory,exp_num,{''');">Scan '},exp_num,{':</a>'},{'    '});
            fun_link_text = fun_link_text_cell{1};
        end
